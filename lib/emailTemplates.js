...
// Pricing sourced from Service Pricing page
...
const headerRow = `<tr style="background:#1a1a2e;color:#fff;"><th style="${thStyle}">Service</th><th style="${thStyle}">What's Included</th><th style="${thStyleR}">Price</th></tr>`;
const altBg = 'background:#f9f9f9;';

function makeAddOns(items) {
  return `<p><strong>Add-ons:</strong> ${items.join(' | ')}</p>`;
}
...
function makeSignature() {
  ...
  <p style="margin:0;color:#888;">&#128231; contact@kapturise.com | &#128222; 055-913-7354</p>
...
export const EMAIL_TEMPLATES = {
  ...
  "food-and-beverage": {
    ...
    subject: "Professional food content for {{company}} — packages from AED 2,500",
  ...
  <table style="${tableStyle}">
    ${headerRow}
    ${row('&#128248; Food Photography', '10 dishes, professional food styling, 3-hour shoot, edited photos', 'AED 2,500 + VAT', true)}
    ${row('&#127916; Food Videography', '5 dishes, 3 social clips (15-30s), 4-hour shoot, editing + music', 'AED 3,500 + VAT', false)}
    ${row('&#128241; Social Media Management', '5 posts/week, 2 platforms, 7 stories/week, 4 reels/month', 'AED 5,000/month', true)}
    ${row('&#128260; Monthly Content Retainer<br><span style="color:#888;font-size:12px;">Best Value</span>', '20 posts/month, 8 reels, 30 stories, full social media management', 'AED 8,000/month', false)}
  </table>
  ${makeAddOns(['Extra Dish +AED 150', 'Extra Social Clip +AED 500', 'Extra Hour +AED 500', 'Food Stylist available', 'Models available', 'Influencer Shoots available', 'Voice Over available', 'AI Videos available'])}
  ...
  "real-estate": {
    name: "Real Estate",
    subject: "Professional property photography & video for {{company}} — from AED 2,000",
    body: `<div style="font-family:Arial,sans-serif;color:#333;line-height:1.6;max-width:600px;">
  <p>Hi {{contactName}},</p>
  ...
  <table style="${tableStyle}">
    ${headerRow}
    ${row('&#127968; Real Estate Photography', '1 property, 30 edited photos, 2-hour shoot', 'AED 2,000 + VAT', true)}
    ${row('&#127910; Event Coverage', '1 photographer + 1 videographer, 4 hours, 1 edited video (60s)', 'AED 3,000 + VAT', false)}
    ${row('&#128241; Social Media Management', '5 posts/week, 2 platforms, 7 stories/week, 4 reels/month', 'AED 5,000/month', true)}
    ${row('&#128260; Monthly Content Retainer<br><span style="color:#888;font-size:12px;">Best Value</span>', '20 posts/month, 8 reels, 30 stories, full social media management', 'AED 8,000/month', false)}
  </table>
  ${makeAddOns(['Extra Property +AED 1,500', 'Drone Coverage +AED 1,000', 'Timelapse +AED 1,500', 'Virtual Tour (360\u00B0) +AED 2,000', 'Extra Hour +AED 500', 'Models available', 'Voice Over available', 'AI Videos available'])}
  ...
  "events": {
    ...
    subject: "Professional event coverage for {{company}} — from AED 3,000",
    body: `<div style="font-family:Arial,sans-serif;color:#333;line-height:1.6;max-width:600px;">
  <p>Hi {{contactName}},</p>
  ...
  <table style="${tableStyle}">
    ${headerRow}
    ${row('&#127910; Event Coverage', '1 photographer + 1 videographer, 4 hours, 1 edited video (60s), delivered 24-48hrs', 'AED 3,000 + VAT', true)}
    ${row('&#128248; Corporate Headshots', '10 people, 3-hour shoot, 1 location, professional retouching', 'AED 3,000 + VAT', false)}
    ${row('&#128241; Social Media Management', '5 posts/week, 2 platforms, 7 stories/week, 4 reels/month', 'AED 5,000/month', true)}
    ${row('&#128260; Monthly Content Retainer<br><span style="color:#888;font-size:12px;">Best Value</span>', '20 posts/month, 8 reels, 30 stories, full social media management', 'AED 8,000/month', false)}
  </table>
  ${makeAddOns(['Extra Photographer +AED 1,500', 'Extra Videographer +AED 1,500', 'Extra Hour +AED 500', 'Extra Video (60s) +AED 750', 'Models available', 'Influencer Coverage available', 'Voice Over available', 'AI Videos available'])}
  ...
  "corporate": {
    ...
    subject: "Professional corporate content for {{company}} — from AED 3,000",
    body: `<div style="font-family:Arial,sans-serif;color:#333;line-height:1.6;max-width:600px;">
  <p>Hi {{contactName}},</p>
  ...
  <table style="${tableStyle}">
    ${headerRow}
    ${row('&#128084; Corporate Headshots', '10 people, 3-hour shoot, 1 location, professional retouching', 'AED 3,000 + VAT', true)}
    ${row('&#127910; Event / Office Coverage', '1 photographer + 1 videographer, 4 hours, 1 edited video (60s)', 'AED 3,000 + VAT', false)}
    ${row('&#127912; Product Photography', '20 SKUs, 3 angles per SKU, 4-hour shoot', 'AED 3,000 + VAT', true)}
    ${row('&#128241; Social Media Management', '5 posts/week, 2 platforms, 7 stories/week, 4 reels/month', 'AED 5,000/month', false)}
    ${row('&#128260; Monthly Content Retainer<br><span style="color:#888;font-size:12px;">Best Value</span>', '20 posts/month, 8 reels, 30 stories, full social media management', 'AED 8,000/month', true)}
  </table>
  ${makeAddOns(['Extra Person +AED 200', 'Extra Location +AED 1,000', 'Extra Hour +AED 500', 'Models available', 'Influencers available', 'Voice Over available', 'AI Videos available'])}
  ...
  "ecommerce": {
    ...
    subject: "Professional product photography for {{company}} — from AED 3,000",
    body: `<div style="font-family:Arial,sans-serif;color:#333;line-height:1.6;max-width:600px;">
  <p>Hi {{contactName}},</p>
  ...
  <table style="${tableStyle}">
    ${headerRow}
    ${row('&#127912; Product Photography', '20 SKUs, 3 angles per SKU, 4-hour shoot, white bg + styled', 'AED 3,000 + VAT', true)}
    ${row('&#127916; Food / Product Videography', '5 products, 3 social clips (15-30s), 4-hour shoot, editing + music', 'AED 3,500 + VAT', false)}
    ${row('&#128241; Social Media Management', '5 posts/week, 2 platforms, 7 stories/week, 4 reels/month', 'AED 5,000/month', true)}
    ${row('&#128260; Monthly Content Retainer<br><span style="color:#888;font-size:12px;">Best Value</span>', '20 posts/month, 8 reels, 30 stories, full social media management', 'AED 8,000/month', false)}
  </table>
  ${makeAddOns(['Extra SKU +AED 100', 'Lifestyle Shot +AED 300', 'Extra Hour +AED 500', 'Models available', 'Influencer Shoots available', 'Voice Over available', 'AI Videos available'])}
  ...
  "hospitality": {
    ...
    subject: "Premium visual content for {{company}} — from AED 2,000",
    body: `<div style="font-family:Arial,sans-serif;color:#333;line-height:1.6;max-width:600px;">
  <p>Hi {{contactName}},</p>
  ...
  <table style="${tableStyle}">
    ${headerRow}
    ${row('&#127968; Property Photography', 'All rooms, exteriors, amenities, 30 edited photos, 2-hour shoot', 'AED 2,000 + VAT', true)}
    ${row('&#127860; Food Photography', '10 dishes, professional food styling, 3-hour shoot', 'AED 2,500 + VAT', false)}
    ${row('&#127910; Event / Venue Coverage', '1 photographer + 1 videographer, 4 hours, 1 edited video (60s)', 'AED 3,000 + VAT', true)}
    ${row('&#128241; Social Media Management', '5 posts/week, 2 platforms, 7 stories/week, 4 reels/month', 'AED 5,000/month', false)}
    ${row('&#128260; Monthly Content Retainer<br><span style="color:#888;font-size:12px;">Best Value</span>', '20 posts/month, 8 reels, 30 stories, full social media management', 'AED 8,000/month', true)}
  </table>
  ${makeAddOns(['Drone Coverage +AED 1,000', 'Virtual Tour (360\u00B0) +AED 2,000', 'Timelapse +AED 1,500', 'Extra Hour +AED 500', 'Models available', 'Food Stylist available', 'Influencers available', 'Voice Over available', 'AI Videos available'])}
  ...
  "general": {
    ...
    subject: "Professional creative content for {{company}} — packages from AED 2,000",
    body: `<div style="font-family:Arial,sans-serif;color:#333;line-height:1.6;max-width:600px;">
  <p>Hi {{contactName}},</p>
  ...
  <table style="${tableStyle}">
    ${headerRow}
    ${row('&#127968; Real Estate Photography', '1 property, 30 edited photos, 2-hour shoot', 'AED 2,000 + VAT', true)}
    ${row('&#128248; Food Photography', '10 dishes, food styling, 3-hour shoot', 'AED 2,500 + VAT', false)}
    ${row('&#127910; Event Coverage', '1 photographer + 1 videographer, 4 hours, 1 edited video', 'AED 3,000 + VAT', true)}
    ${row('&#128084; Corporate Headshots', '10 people, 3-hour shoot, retouching', 'AED 3,000 + VAT', false)}
    ${row('&#127912; Product Photography', '20 SKUs, 3 angles each, 4-hour shoot', 'AED 3,000 + VAT', true)}
    ${row('&#127916; Food / Product Videography', '5 items, 3 social clips, 4-hour shoot', 'AED 3,500 + VAT', false)}
    ${row('&#128241; Social Media Management', '5 posts/week, 2 platforms, 7 stories/week, 4 reels/month', 'AED 5,000/month', true)}
    ${row('&#128260; Monthly Content Retainer', '20 posts, 8 reels, 30 stories, full social media mgmt', 'AED 8,000/month', false)}
  </table>
  ${makeAddOns(['Models available', 'Food Stylist available', 'Influencer Shoots available', 'Voice Over available', 'AI Videos available', 'Drone Coverage +AED 1,000', 'Virtual Tour +AED 2,000'])}
