...
${row('&#129302; AI Product Video', 'AI video with real people (30-60s), script, motion graphics, music', 'AED 3,000 + VAT', true)}
</table>
...
${row('&#129302; AI Property Video', 'AI listing video (30-60s), script, motion graphics, music', 'AED 3,000 + VAT', true)}
</table>
...
${row('&#129302; AI Event Promo Video', 'AI promo/recap video (30-60s), script, motion graphics, music', 'AED 3,000 + VAT', false)}
</table>
...
${row('&#129302; AI Brand Video', 'AI video (30-60s), script, motion graphics, music', 'AED 3,000 + VAT', true)}
</table>
<p style="color:#888;font-size:12px;">* Starting prices, excl. 5% VAT.</p>
...
${row('&#129302; AI Product Video', 'AI product video (30-60s), script, motion graphics, music', 'AED 3,000 + VAT', true)}
</table>
<p style="color:#888;font-size:12px;">* Starting prices, excl. 5% VAT.</p>
${portfolio([['Talabat Campaign', PORTFOLIO.talabat], ['Emigala Event', PORTFOLIO.emigala]])}
${profileLink()}
...
${row('&#129302; AI Hotel Video', 'AI showcase video (30-60s), script, motion graphics, music', 'AED 3,000 + VAT', true)}
</table>
...
${row('&#129302; AI Video (One-off)', 'AI video (30-60s), script, motion graphics, music', 'from AED 1,500 + VAT', false)}
</table>
<p style="color:#888;font-size:12px;">* Starting prices, excl. 5% VAT. Customized based on scope.</p>
...
const INDUSTRY_KEYWORDS = {
  investor: ['vc', 'venture', 'capital', 'invest', 'angel', 'family office', 'fund', 'private equity', 'accelerator', 'incubator'],
  'food-and-beverage': ['restaurant', 'cafe', 'coffee', 'bakery', 'catering', 'food', 'beverage', 'f&b', 'cloud kitchen', 'meal', 'dining', 'grocery', 'grocer'],
  'real-estate': ['real estate', 'property', 'realty', 'developer', 'construction', 'building', 'architecture', 'interior'],
  events: ['event', 'conference', 'wedding', 'exhibition', 'gala', 'expo', 'summit', 'festival', 'concert', 'trade show'],
  corporate: ['tech', 'consult', 'finance', 'bank', 'insurance', 'saas', 'software', 'it ', 'digital', 'marketing agency', 'media', 'publish', 'telecom', 'industrial', 'machinery', 'equipment', 'manufactur', 'engineer', 'automotive', 'auto ', 'logistics', 'supply chain', 'transport', 'shipping', 'healthcare', 'medical', 'pharma', 'clinic', 'hospital', 'education', 'university', 'school', 'training', 'legal', 'law firm', 'energy', 'oil', 'gas', 'aviation', 'airline', 'government', 'public sector'],
  ecommerce: ['ecommerce', 'e-commerce', 'retail', 'shop', 'store', 'marketplace', 'fashion', 'apparel', 'luxury', 'jewel', 'watch', 'beauty', 'cosmetic'],
  hospitality: ['hotel', 'resort', 'spa', 'wellness', 'hostel', 'tourism', 'travel', 'hospitality', 'leisure', 'entertainment', 'fitness', 'gym'],
};
